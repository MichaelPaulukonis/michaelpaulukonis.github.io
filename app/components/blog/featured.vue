<template>
    <div class="bg-gray-300 rounded-md border-2 border-typography_primary hover--bg-gray-400 hover--border-[#7d5cff] hover--outline hover--outline-2 hover--outline-[#7d5cff] group relative mb-8">
